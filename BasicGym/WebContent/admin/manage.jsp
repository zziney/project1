...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="100">
    ...
    <!-- 본문 -->		
    	<div class="site-section section-1">
		     <div class="container">
		     	<h3 class="main title"  style="text-align:center">관리자페이지입니다.</h3>		     			     		     		     
		     	<div class="col-md-12">
		     		<table class="table">
						<tr>
							<th class="w60" style=width:10%>번호</th>
							<td class="title indent text-align-left"><a href="#">회원관리</a></td>
						</tr>
						<tr>
							<th colspan="expand" style=width:35%>제목</th>
							<td class="title indent text-align-left"><a href="../lesson/editLessonList">강좌관리</a></td>
						</tr>
						<tr>
							<th colspan="w100" style=width:20%>작성자</th>
							<td class="title indent text-align-left"><a href="#">주문관리</a></td>
						</tr>
						<tr>
							<th colspan="w100" style=width:25%>작성일</th>
							<td class="title indent text-align-left"><a href="#">게시판관리</a></td>
						</tr>
		     	</table>
		     	</div>
		     </div>
